...
class ProductController extends Controller
{
    ...
    public function create()
    {
      ...
      $category_ids = Category::whereNotNull('category_id')->select('category_id')->get()->toArray();
      // dd($category_ids);
      $categories=Category::whereNotIn('id',$category_ids)->get();
      //dd($categories);
    ...
    public function store(Request $request)
    {
        ...
        if($request->hasFile('image'))
        {
         ...
         if($create)
         {
           ...
           return redirect('/products')->with('message', 'Product is added successfully.'); 
         }
    ...
    public function destroy(Product $product, Request $request)
    {
        ...
        $product->delete();
        return response()->json(['message'=>'Product is Deleted.', 'status'=>'success']);
