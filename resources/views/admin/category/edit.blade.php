...
<div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" method="post" action="{{route('category.update',$category->id)}}" data-parsley-validate class="form-horizontal form-label-left">
                     @csrf
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="subcategory of">Subcategory of <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
