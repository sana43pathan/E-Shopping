...
Route::get('/products/{id}', [BaseController::class,'products'])->name('products');

Route::get('/tac', [BaseController::class,'termsandConditions'])->name('tac');
...
Route::post('/contact-us/store', [ContactMessageController::class,'store'])->name('contactMessage.store');
...
Route::get('/productDetails/{id}', [BaseController::class,'productDetails'])->name('productDetails');
